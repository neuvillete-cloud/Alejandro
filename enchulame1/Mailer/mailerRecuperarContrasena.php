...
<head>
                                ...
                                <tbody>
                                    <tr>
                                        <td id='logo' style='background-color:#005195; padding-top:3%; padding-bottom:3%; text-align:center;'>
                                             <a href='https://grammermx.com/AleTest/enchulame1/index.php'>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class='aligncenter content-block' style='box-sizing:border-box; font-size:12px; padding:0 0 20px; margin:0 auto;'>
                                                <a href='https://grammermx.com/AleTest/enchulame1/index.php' style='text-decoration:none; color:#82AFD7; float:none; vertical-align:middle;'>© Grammer Querétaro.</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
    ...
    try {
        ...
        $mail->Port = 465;
        $mail->SMTPAuth = true;
        $mail->Username = 'tickets_enchulamelanave@grammermx.com'; //Correo de quien envia el email
        ...
        $mail->addBCC('tickets_enchulamelanave@grammermx.com', 'Administracion');
        $mail->addBCC('extern.alejandro.torres@grammer.com', 'TI');

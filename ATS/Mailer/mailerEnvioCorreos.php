...
try {
    ...
    // Se añade 'Puesto' a la consulta para usarlo en el correo
    ...
    // Se pasan los nuevos parámetros a la función
...
// La función ahora acepta $puesto y $url_sitio para el nuevo template
function enviarCorreoNotificacion($email1, $email2, $email3, $folio, $puesto, $link, $url_sitio) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'sistema_ats@grammermx.com'; // Corregido: 'grammermx' en lugar de 'gramermx'
        $mail->Password = 'SATSGrammer2024.';
        $mail->SMTPSecure = 'ssl';
        $mail->Port = 465;

        // Remitente y Destinatarios
        $mail->setFrom('sistema_ats@grammermx.com', 'Grammer ATS Administration');

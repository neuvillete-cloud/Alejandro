...
<head>
    ...
    <style>
        ...
        /* --- Ajustes para Clasificación de Defectos Safe Launch (Estilo Original) --- */
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (data.status === 'success') {
                        ...
                        if (defectosGuardados && defectosGuardados.length > 0) {
                            ...
                            defectosGuardadosMap.forEach(defNuevo => {
                                // Aquí necesitas el ID del registro específico de SafeLaunchReporteDefectos si quieres permitir eliminarlos después
                                // Asumiendo que el DAO lo devuelve como 'IdSLReporteDefecto'
        ...
        const pdfUrl = '<?php echo $mostrarVisorInstruccion ? htmlspecialchars($solicitudSL['RutaInstruccion']) : ''; ?>';

...
// =========================================================================================================
// Aunque ocultemos el botón en el index, debemos validar aquí también para evitar acceso por URL directa.
...
//$conexSeguridad->close(); // Mantenemos la conexión o la cerramos, pero abajo abres otra, así que cerramos esta para limpieza.
...
if (!$accesoPermitido) {
    ...
    <body>
        <div class="error-card">
            ...
            <p>Lo sentimos, solo el personal interno con correo corporativo (@grammer.com) tiene autorización para crear nuevas solicitudes de contención.</p>
...
// NOTA: Reutilizamos include, pero creamos nueva instancia según tu código original para no romper variables de abajo.

...
<main class="container">
    <div class="form-container">
        <h1 data-translate-key="mainTitle"><i class="fa-solid fa-file-circle-plus"></i> Crear Nueva Solicitud de Contención</h1>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const translations = {
            'es': {
                ...
                'swal_addSupplier': 'Añadir Nuevo Proveedor', 'swal_addLocation': 'Añadir Nuevo Lugar', 'swal_addTertiary': 'Añadir Nueva Terciaria',
            ...
            'en': {
                ...
                'swal_addSupplier': 'Add New Supplier', 'swal_addLocation': 'Add New Location', 'swal_addTertiary': 'Add New Tertiary',
        ...
        // 4. Revisa si hay un idioma guardado
        ...
        btnAddDefecto.addEventListener('click', function() {
            ...
            defectoCounter++;
            // Usamos el diccionario para el texto dinámico
            const defectoHTML = `
        ...
        document.querySelectorAll('.btn-add').forEach(button => {
            button.addEventListener('click', function() {
                ...
                const titulos = {
                    proveedor: translations[currentLang].swal_addSupplier,
                    lugar: translations[currentLang].swal_addLocation,
                    terciaria: translations[currentLang].swal_addTertiary
                };

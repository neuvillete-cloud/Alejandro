...
<script>
    !function(e,t){"function"==typeof define&&define.amd?define(t):"object"==typeof exports?module.exports=t():e.Clocklet=t()}(this,function(){"use strict";var e,t,n,i,o,a,r,s,l,c,u,d,p,h,m,f,g,b,v,y,w,k,L,C,x,H,S,M,E,O,I,N,T,D,A,P,_,B,F,R,q,j,z,U,W,X,Y,V,G,J,K,Q,Z,$,ee,te,ne,ie;return k=function(e){var t;return t={},t.default=e,t},L=function(e){var t,n;for(t=0,n=e.length;n>t;t++)e[t].apply(this,Array.prototype.slice.call(arguments,1))},C=function(e,t,n){e.addEventListener?e.addEventListener(t,n):e.attachEvent("on"+t,function(){n.call(e)})},x="[data-clocklet]",H=document.ontouchstart,S="click",M="mousedown",E="mouseup",O="mousemove",H&&(S="touchend",M="touchstart",E="touchend",O="touchmove"),I="clocklet-modal-container",N="clocklet-modal",T="clocklet-header-time",D="clocklet-hand",A="clocklet-tick",P="is-shown",_="is-active",B="is-hidden",F="is-disabled",c=function(e){return("0"+e).slice(-2)},u=function(e,t){var n,i;for(n in t)i=t[n],i instanceof Array?u(e[n]||(e[n]=[]),i):i instanceof Object?u(e[n]||(e[n]={}),i):e[n]=i;return e},r=!1,s="hour",l=function(t){var n;n=t,e.dataset.clockletFormat&&(n=p(t,e.dataset.clockletFormat)),e.value=n},a=function(e,t){var n;n=t.getBoundingClientRect();var i,o;return H?(i=t.changedTouches[0].clientX,o=t.changedTouches[0].clientY):e.preventDefault?(i=t.clientX,o=t.clientY):e.returnValue=!1,(i-=n.left)-120,(o-=n.top)-120},d=function(){var n,i,o,r,s,u;return u=a(event,g),s=180*Math.atan2(u[0],-u[1])/Math.PI,t.hour&&(n=Math.round(s/30)),"minute"===t.mode&&(n=Math.round(s/6)),"hour"===t.mode&&(n%=12,n=n||12,t.format_24_clock||(o=e.value.match(/(am|pm)/i))&&"pm"===o[0].toLowerCase()&&(n%=12,n+=12)),"minute"===t.mode&&t.vibrate&&navigator.vibrate(1),n=c(n),i=e.value.split(":"),r=e.value.match(/(am|pm)/i),t.hour=t.hour||i[0],t.minute=t.minute||i[1].replace(/\s*(am|pm)/i,""),"hour"===t.mode?t.hour=n:"minute"===t.mode&&(t.minute=n),l(t.hour+":"+t.minute+(r?" "+r[0]:""))},p=function(e,t){var n,i,o;return e=e.replace(/(am|pm)/i,"").split(":"),(n=e[0])>12&&(n-=12,o="pm"),n||(n=12),12>n&&(o="am"),t=t.replace(/hh/i,c(n)),t=t.replace(/h/i,n),t=t.replace(/mm/i,c(e[1])),t=t.replace(/m/i,e[1]),t=t.replace(/AM/i,o.toUpperCase()),t=t.replace(/am/i,o.toLowerCase()),t=t.replace(/a/i,o.toLowerCase())},h=function(){var e,n,a,r,c,u;if(c=event.target,c.classList.contains(A)){if(c.classList.contains(F))return;switch(a=c.textContent,t.vibrate&&navigator.vibrate(1),"hour"===t.mode?(t.hour=a,s="minute"):"minute"===t.mode&&(t.minute=a),e=t.hour+":"+t.minute+(t.format_24_clock?"":e=c.textContent,"am"===t.meridiem?e+=" am":e+=" pm"),u=e,r=document.createEvent("HTMLEvents"),r.initEvent("change",!0,!0),i.value=u,i.dispatchEvent(r),t.autoclose){case!0:return void(n=setTimeout(function(){return clearTimeout(n),W()},300));case"minute":"minute"===t.mode&&L(j,z);break;case"hour":"hour"===t.mode&&L(j,z)}}c.classList.contains(T)&&(s="hour"===t.mode?"minute":"hour"),q()},m=function(){L(j,z)},f=function(){var e;e=event.target,e.classList.contains(T)&&(t.meridiem="am"===t.meridiem?"pm":"am",q())},g=document.createElement("div"),b=document.createElement("div"),v=document.createElement("a"),y=document.createElement("a"),w=document.createElement("div"),X=function(e){var t,n;for(g.innerHTML="",t=0;12>t;t++)n=document.createElement("div"),n.className=A,n.textContent=c(t||12),g.appendChild(n)},Y=function(e){var t,n;for(g.innerHTML="",t=0;60>t;t+=5)n=document.createElement("div"),n.className=A,n.textContent=c(t),g.appendChild(n)},V=function(){return"hour"===s?X():Y()},G=function(){var e,n,o,a;for(o=g.children,n=0,a=o.length;a>n;n++)e=o[n],e.style.transform="translate(-50%,-50%) rotate("+"hour"===s?30*e.textContent:6*e.textContent+"deg) translateY(-96px) rotate("+"hour"===s?-30*e.textContent:-6*e.textContent+"deg)",e.style.webkitTransform="translate(-50%,-50%) rotate("+"hour"===s?30*e.textContent:6*e.textContent+"deg) translateY(-96px) rotate("+"hour"===s?-30*e.textContent:-6*e.textContent+"deg)"},J=function(){var t,n,i,o,a;for(o=g.children,n=0,a=o.length;a>n;n++)t=o[n],i="hour"===s?1*e.value.replace(/:.*/,""):1*e.value.replace(/.*:/,"").replace(/\D/g,""),i===1*t.textContent?t.classList.add(_):t.classList.remove(_)},K=function(){var t;t=e.value.match(/(am|pm)/i),t&&(v.textContent="AM",y.textContent="PM","am"===t[0].toLowerCase()?(v.classList.add(_),y.classList.remove(_)):(v.classList.remove(_),y.classList.add(_)))},Q=function(e){var t,n,o;return t=e.split(":"),(n=t[0])>12&&(o="pm"),n||(n=12),12>n&&(o="am"),i.hour=c(n),i.minute=c(t[1].replace(/\D/g,"")),i.meridiem=o,i},Z=function(){var e,n;n=document.createElement("div"),e=document.createElement("div"),v=document.createElement("div"),y=document.createElement("div"),z=document.createElement("button"),U=document.createElement("button"),v.classList.add(T),y.classList.add(T),e.classList.add("clocklet-hand-point"),n.classList.add(D),n.appendChild(e),o.classList.add(N),w.classList.add(I),g.classList.add("clocklet-plate"),b.classList.add("clocklet-display"),t=document.createElement("div"),t.classList.add("clocklet-header"),i=document.createElement("div"),i.classList.add("clocklet-footer"),z.classList.add("clocklet-button"),z.textContent="OK",U.classList.add("clocklet-button"),U.textContent="Cancel",C(z,S,function(){L(j,z)}),C(U,S,m),C(o,M,function(e){e.stopPropagation()}),C(w,M,m),b.appendChild(g),b.appendChild(n),t.appendChild(v),t.appendChild(y),o.appendChild(t),o.appendChild(b),o.appendChild(i),i.appendChild(U),i.appendChild(z),w.appendChild(o),document.body.appendChild(w)},$=function(e){t=e,t.vibrate=t.vibrate&&"vibrate"in navigator,i.dataset.theme=t.theme,t.format_24_clock?v.classList.add(B):v.classList.remove(B),t.format_24_clock?y.classList.add(B):y.classList.remove(B)},ee=function(e,t,n){return t>e?e=t:e>n&&(e=n),e},te=function(t,n){var i,o,r,s;return r="hour"===n,s=t-120,o=Math.atan2(s[0],-s[1]),i=o/(Math.PI/180),r?30*ee(Math.round(i/30),1,12):6*ee(Math.round(i/6),0,59)},q=function(){var t,i,o,a;e.value?(t=e.value.split(":"),i=t[0].replace(/\D/g,""),a=t[1].replace(/\D/g,"")):(o=new Date,i=o.getHours(),a=o.getMinutes()),v.textContent=c(i),y.textContent=c(a),n.style.transform="rotate("+"hour"===s?30*(i%12||12):6*a+"deg)",n.style.webkitTransform="rotate("+"hour"===s?30*(i%12||12):6*a+"deg)","hour"===s?(v.classList.add(_),y.classList.remove(_)):(v.classList.remove(_),y.classList.add(_)),V(),G(),J(),K()},ne=function(){var i,a,u,p;return i=this,"function"==typeof t&&(t=t()),i.tagName||(i=document.querySelector(i)),i?(e=i,n=u={},"INPUT"!==e.tagName&&e.querySelector("input")&&(e=e.querySelector("input")),a=e.dataset.clocklet,e.clocklet?void 0:(u=Q(e.value||"12:00"),a&&/\{.*\}/.test(a)?p=JSON.parse(a):p={},$(p),e.clocklet=!0,e.readOnly=!0,C(e,S,function(){event.stopPropagation(),W()}),r||(Z(),r=!0))):void 0},ie=function(){var e,t,n,i,o;for(i=document.querySelectorAll(x),t=0,o=i.length;o>t;t++)e=i[t],(n=new ne(e)).open=W,n.close=m,e.clocklet=n},W=function(t){var i,a;if(t&&(e=t),e){if(i=e.value||"12:00 am",s="hour","object"==typeof n)a=n;else{var r;r=e.dataset,a={},r.clockletFormat&&(a.format=r.clockletFormat),r.clockletTheme&&(a.theme=r.clockletTheme)}return u(i,a),w.classList.add(P),o.classList.add(P),q(),C(document,M,d),C(document,O,d),C(g,S,h),void C(b,S,f)}},j=new CustomEvent("finish"),z=new CustomEvent("cancel"),C(document,S,function(){"INPUT"!==event.target.tagName&&m()}),"undefined"!=typeof document&&null!==document&&C(document,"DOMContentLoaded",ie),ne.run=ie,ne});
</script>
<script>
